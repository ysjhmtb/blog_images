...
/*
이 문제를 마지막으로 NHNENT의 올해 문제를 모두 풀었다.
...
class Solution {
    public static void main(String[] args) {
        ...
        a1 = new String[]{"A", "0", "0", "0", "0"};
        a2 = new String[]{"0", "0", "0", "0", "0"};
        a3 = new String[]{"0", "0", "0", "0", "0"};
        a4 = new String[]{"0", "0", "0", "0", "0"};
        a5 = new String[]{"0", "0", "0", "0", "B"};
    ...
    */
    ...
    public List<List<Integer>> getDirection(int i, int j, List<List<String>> arr) {
        ...
        if (cur >= 4) {
            cur -= 4;
            result.set(2, new ArrayList<Integer>());
            check[2] = false;
        }
